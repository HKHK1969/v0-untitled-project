...
import { z } from "zod"
import { validateInput, sanitizeString } from "@/lib/api-validation"
import { aiAssistantRateLimiter } from "@/lib/rate-limiter"
...
export async function POST(req: NextRequest) {
  try {
    ...
    const rateLimitResult = aiAssistantRateLimiter.check(identifier)
    ...
    const sanitizedMessages = validatedData.messages.map((msg) => ({
      ...msg,
