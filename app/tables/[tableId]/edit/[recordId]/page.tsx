...
export default function EditRecordPage({ params }: EditRecordPageProps) {
  ...
  const handleSubmit = useCallback(
    ...
    [tableId, recordId, formData, debugMode, tableDefinition, router, validateForm, sanitizeFormData],
  )

  const renderMultiValueField = useCallback(
    (field: Field, newValue: string, setNewValue: (val: string) => void, placeholder: string) => {
      return (
