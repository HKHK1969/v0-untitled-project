...
import { ProductionMigrationBanner } from "@/components/production-migration-banner"
import { PilotLaunchBanner } from "@/components/pilot-launch-banner"
      ...
      <header className="bg-background border-b">
        <div className="container flex h-16 items-center px-4 md:px-6">
          ...
          <nav className="ml-auto flex gap-4 sm:gap-6">
            ...
            <Link href="/pilot-dashboard" className="text-sm font-medium hover:underline underline-offset-4">
              Pilot Dashboard
            </Link>
          </nav>
        </div>
