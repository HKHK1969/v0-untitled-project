...
export default function CreateTablePage() {
  ...
  // Add cleanup for debounced functions to prevent memory leaks
  useEffect(() => {
    return () => {
      debouncedSetTableName.cancel()
      debouncedSetTableDescription.cancel()
    }
  }, [debouncedSetTableName, debouncedSetTableDescription])
  ...
  const handleCreateTable = useCallback(async () => {
    ...
    try {
      ...
      console.log("[v0] Creating table:", tableData)
      ...
      console.log("[v0] Table saved to localStorage successfully")

      window.dispatchEvent(new CustomEvent("tableCreated", { detail: tableData }))
