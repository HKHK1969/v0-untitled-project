...
import { generatePurchaseOrderData } from "@/lib/chart-utils"
import {
  Bar,
  BarChart,
  CartesianGrid,
...
export default function PurchaseOrdersPage() {
  ...
  const data = generatePurchaseOrderData()

  return (
    <DashboardLayout>
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold">Purchase Order Analysis</h1>
          <p className="text-muted-foreground">Track and analyze purchase order lead times and performance</p>
        </div>
          ...
          <div className="flex justify-between">
            <Tabs defaultValue="overview" className="w-full">
              ...
              <TabsContent value="overview" className="mt-4">
                <Card>
                  <CardHeader>
                    <CardTitle>Overall Purchase Order Lead Time</CardTitle>
                    <CardDescription>Average time from order placement to delivery across all orders</CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="by-customer" className="mt-4">
                <Card>
                  <CardHeader>
                    <CardTitle>Purchase Order Lead Time by Customer</CardTitle>
                    <CardDescription>Average order lead time broken down by customer</CardDescription>
                  </CardHeader>
                  <CardContent>
                    {view === "chart" ? (
              ...
              <TabsContent value="by-supplier" className="mt-4">
                <Card>
                  <CardHeader>
                    <CardTitle>Purchase Order Lead Time by Supplier</CardTitle>
                    <CardDescription>Average order lead time broken down by supplier</CardDescription>
                  </CardHeader>
                  <CardContent>
                    {view === "chart" ? (
                      <div className="h-[400px]">
              ...
              <TabsContent value="evolution" className="mt-4">
                <Card>
                  <CardHeader>
                    <CardTitle>Purchase Order Lead Time Evolution</CardTitle>
                    <CardDescription>How order lead times have changed over time</CardDescription>
                  </CardHeader>
                  <CardContent>
                    {view === "chart" ? (
                      <div className="h-[400px]">
              ...
              <TabsContent value="delays" className="mt-4">
                <Card>
                  <CardHeader>
                    <CardTitle>Purchase Order Delays by Supplier</CardTitle>
